...
object ProductosSource {
        ...
        val productos = listOf(
                ...
                Producto(sku = "PI001", nombre = "Mousse de Chocolate", descripcion = "Postre individual cremoso y suave, hecho con chocolate de alta calidad, ideal para los amantes del chocolate.", categoria = "normal", precio = 5000.0, imageUrl = "pi001", destacado = false),
                Producto(sku = "PI002", nombre = "Tiramisú Clásico", descripcion = "Un postre italiano individual con capas de café, mascarpone y cacao, perfecto para finalizar cualquier comida.", categoria = "normal", precio = 5500.0, imageUrl = "pi002", destacado = false),
                ...
                Producto(sku = "TE001", nombre = "Torta Especial de Cumpleaños", descripcion = "Diseñada especialmente para celebraciones, personalizable con decoraciones y mensajes únicos.", categoria = "normal", precio = 55000.0, imageUrl = "te001", destacado = true),
                Producto(sku = "TE002", nombre = "Torta Especial de Boda", descripcion = "Elegante y deliciosa, diseñada para ser el centro de atención en cualquier boda.", categoria = "normal", precio = 60000.0, imageUrl = "te002", destacado = false)
        )
}